...
// Filosofia Logica, estilos y HTML en un solo archivo
...
@keyframes show-message {
  ...
  // Con este tipo de inserción tenemos que tener cuidado con las contra barras \
  // Js cree que es un caracter especial y se resuelve poniendo una segunda
  $form.innerHTML = `
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/gunsnroses.2617@gmail.com", {
        ...
        .catch((err) => {
          // console.log(err);
          let message =
            err.statusText || "Oucrrió un error al enviar, intenta nuevamente";
